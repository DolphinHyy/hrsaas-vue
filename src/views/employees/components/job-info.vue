<template>
  <div class="job-info">
    <i
      ...
      @click="$router.push('/employees/print/'+userId)"
    />
    <!-- 基础信息 -->
...
<script>
import { getJobInfoAPI, updateJobInfoAPI } from '@/api/staff'
...
export default {
  ...
  methods: {
    async getJobInfo() {
      this.formData = await getJobInfoAPI(this.userId)
      // console.log(this.formData)
    },
    async saveJob() {
      // console.log(1)
      await updateJobInfoAPI({ ...this.formData, id: this.userId })
