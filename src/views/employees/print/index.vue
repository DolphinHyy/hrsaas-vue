  ...
  <div id="myPrint" class="dashboard-container">
    <div class="app-container">
      <el-card>
        ...
        <el-button v-print="'#myPrint'" size="mini">打印</el-button>
...
<script>
import { getStaffInfoAPI, getJobInfoAPI } from '@/api/staff'
...
export default {
  ...
  methods: {
    async getPersonalDetail() {
      this.formData = await getStaffInfoAPI(this.userId) // 获取个人基本信息
      console.log(this.formData)
    },
    async getJobDetail() {
      const userInfo = await getUserDetailAPI(this.userId)
      const jobInfo = await getJobInfoAPI(this.userId) // 获取个人基本信息
